...
INTEGER (C_INT64_T ), PARAMETER :: NX = 600
INTEGER (C_INT64_T ), PARAMETER :: NZ = 300
REAL (C_DOUBLE ), PARAMETER :: DX = 33.333333333333336
REAL (C_DOUBLE ), PARAMETER :: DZ = 33.333333333333336
...
REAL (C_DOUBLE ), DIMENSION(-1:602, -1:302, 1:4), INTENT(IN) :: state
REAL (C_DOUBLE ), DIMENSION(-1:602, -1:302, 1:4), INTENT(IN) :: statetmp
REAL (C_DOUBLE ), DIMENSION(1:601, 1:301, 1:4), INTENT(IN) :: flux
REAL (C_DOUBLE ), DIMENSION(1:600, 1:300, 1:4), INTENT(IN) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:302), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:302), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:301), INTENT(IN) :: hy_dens_int
REAL (C_DOUBLE ), DIMENSION(1:301), INTENT(IN) :: hy_dens_theta_int
REAL (C_DOUBLE ), DIMENSION(1:301), INTENT(IN) :: hy_pressure_int
...
REAL (C_DOUBLE ), DIMENSION(-1:302), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:302), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:601, 1:301, 1:4), INTENT(OUT) :: flux
REAL (C_DOUBLE ), DIMENSION(1:600, 1:300, 1:4), INTENT(OUT) :: tend
