...
INTEGER (C_INT64_T ), PARAMETER :: NX = 100
INTEGER (C_INT64_T ), PARAMETER :: NZ = 50
REAL (C_DOUBLE ), PARAMETER :: DX = 200.0
REAL (C_DOUBLE ), PARAMETER :: DZ = 200.0
...
REAL (C_DOUBLE ), DIMENSION(-1:102, -1:52, 1:4), INTENT(IN) :: statetmp
REAL (C_DOUBLE ), DIMENSION(1:101, 1:51, 1:4), INTENT(IN) :: flux
REAL (C_DOUBLE ), DIMENSION(1:100, 1:50, 1:4), INTENT(IN) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:52), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:52), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:51), INTENT(IN) :: hy_dens_int
REAL (C_DOUBLE ), DIMENSION(1:51), INTENT(IN) :: hy_dens_theta_int
REAL (C_DOUBLE ), DIMENSION(1:51), INTENT(IN) :: hy_pressure_int
...
REAL (C_DOUBLE ), DIMENSION(-1:52), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:52), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:101, 1:51, 1:4), INTENT(OUT) :: flux
REAL (C_DOUBLE ), DIMENSION(1:100, 1:50, 1:4), INTENT(OUT) :: tend
