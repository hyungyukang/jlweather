...
INTEGER (C_INT64_T ), PARAMETER :: NX = 2000
INTEGER (C_INT64_T ), PARAMETER :: NZ = 1000
REAL (C_DOUBLE ), PARAMETER :: DX = 10.0
REAL (C_DOUBLE ), PARAMETER :: DZ = 10.0
...
REAL (C_DOUBLE ), DIMENSION(-1:2002, -1:1002, 1:4), INTENT(IN) :: state
REAL (C_DOUBLE ), DIMENSION(-1:2002, -1:1002, 1:4), INTENT(IN) :: statetmp
REAL (C_DOUBLE ), DIMENSION(1:2001, 1:1001, 1:4), INTENT(IN) :: flux
REAL (C_DOUBLE ), DIMENSION(1:2000, 1:1000, 1:4), INTENT(IN) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:1002), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:1002), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:1001), INTENT(IN) :: hy_dens_int
REAL (C_DOUBLE ), DIMENSION(1:1001), INTENT(IN) :: hy_dens_theta_int
REAL (C_DOUBLE ), DIMENSION(1:1001), INTENT(IN) :: hy_pressure_int
...
REAL (C_DOUBLE ), DIMENSION(-1:1002), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:1002), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:2001, 1:1001, 1:4), INTENT(OUT) :: flux
REAL (C_DOUBLE ), DIMENSION(1:2000, 1:1000, 1:4), INTENT(OUT) :: tend
