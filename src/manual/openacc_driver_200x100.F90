...
INTEGER (C_INT64_T ), PARAMETER :: NX = 200
INTEGER (C_INT64_T ), PARAMETER :: NZ = 100
REAL (C_DOUBLE ), PARAMETER :: DX = 100.0
REAL (C_DOUBLE ), PARAMETER :: DZ = 100.0
...
REAL (C_DOUBLE ), DIMENSION(-1:202, -1:102, 1:4), INTENT(IN) :: state
REAL (C_DOUBLE ), DIMENSION(-1:202, -1:102, 1:4), INTENT(IN) :: statetmp
REAL (C_DOUBLE ), DIMENSION(1:201, 1:101, 1:4), INTENT(IN) :: flux
REAL (C_DOUBLE ), DIMENSION(1:200, 1:100, 1:4), INTENT(IN) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:102), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:102), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:101), INTENT(IN) :: hy_dens_int
REAL (C_DOUBLE ), DIMENSION(1:101), INTENT(IN) :: hy_dens_theta_int
REAL (C_DOUBLE ), DIMENSION(1:101), INTENT(IN) :: hy_pressure_int
...
REAL (C_DOUBLE ), DIMENSION(-1:102), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:102), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:201, 1:101, 1:4), INTENT(OUT) :: flux
REAL (C_DOUBLE ), DIMENSION(1:200, 1:100, 1:4), INTENT(OUT) :: tend
