...
INTEGER (C_INT64_T ), PARAMETER :: NX = 400
INTEGER (C_INT64_T ), PARAMETER :: NZ = 200
REAL (C_DOUBLE ), PARAMETER :: DX = 50.0
REAL (C_DOUBLE ), PARAMETER :: DZ = 50.0
...
REAL (C_DOUBLE ), DIMENSION(-1:402, -1:202, 1:4), INTENT(IN) :: state
REAL (C_DOUBLE ), DIMENSION(-1:402, -1:202, 1:4), INTENT(IN) :: statetmp
REAL (C_DOUBLE ), DIMENSION(1:401, 1:201, 1:4), INTENT(IN) :: flux
REAL (C_DOUBLE ), DIMENSION(1:400, 1:200, 1:4), INTENT(IN) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:202), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:202), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:201), INTENT(IN) :: hy_dens_int
REAL (C_DOUBLE ), DIMENSION(1:201), INTENT(IN) :: hy_dens_theta_int
REAL (C_DOUBLE ), DIMENSION(1:201), INTENT(IN) :: hy_pressure_int
...
REAL (C_DOUBLE ), DIMENSION(-1:202), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:202), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:401, 1:201, 1:4), INTENT(OUT) :: flux
REAL (C_DOUBLE ), DIMENSION(1:400, 1:200, 1:4), INTENT(OUT) :: tend
